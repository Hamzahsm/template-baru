...
<html lang="en">
  <head>
    ...
    <title>Guildwars 2 - MMOPILOT</title>
            ...
            <div class="carousel-inner">
              ...
              <div class="carousel-item active">
                <div class="row">
                  <div class="col-lg-8 pr-lg-1">
                    <a href="#">
                      <div class="d-flex h-100 bs-c br-n bp-c ar-8_5 position-relative" style="background-image: url(../assets/img/content/cont/guild\ empat.jpg);">
                      </div>
                    </a>
                  </div>
                  <div class="col-lg-4 d-none d-lg-block pl-lg-1">
                    <div class="row no-gutters h-100">
                      <div class="col-12 pb-1">
                        <a href="#">
                          <div class="d-flex h-100 bs-c br-n bp-c position-relative" style="background-image: url(../assets/img/content/cont/product\ guild\ satu.png);"></div>
                        </a>
                      </div>
                      <div class="col-12 pt-1">
                        <a href="#">
                          <div class="d-flex h-100 bs-c br-n bp-c position-relative" style="background-image: url(../assets/img/content/cont/product\ guild\ dua.png);"></div>
                        </a>
                      </div>
                    </div>  
                  </div>
              ...
              <div class="carousel-item">
                <div class="row">
                  <div class="col-lg-8 pr-lg-1">
                    <a href="#">
                      <div class="d-flex h-100 bs-c br-n bp-c ar-8_5 position-relative" style="background-image: url(../assets/img/content/cont/guild\ dua.jpg);">
                      </div>
                    </a>
                  </div>
                  <div class="col-lg-4 d-none d-lg-block pl-lg-1">
              ...
              <div class="carousel-item">
                <div class="row">
                  <div class="col-lg-8 pr-lg-1">
                    <a href="#">
                      <div class="d-flex h-100 bs-c br-n bp-c ar-8_5 position-relative" style="background-image: url(../assets/img/content/cont/guild\ tiga.jpg);">
                      </div>
                    </a>
                  </div>
                  <div class="col-lg-4 d-none d-lg-block pl-lg-1">
                    ...
                    <div class="row">
                        ...
                        <a href="./power-leveling-150.html" class="product-item">
                          <div class="row align-items-center no-gutters">
                            <div class="item_img d-none d-sm-block">
                              <img class="img bl-3 text-primary" src="../assets/img/content/cont/product guild satu.png" alt="Games Store" >
                            </div>
                            <div class="item_content flex-1 flex-grow pl-0 pl-sm-6 pr-6">
                              <h6 class="item_title ls-1 small-1 fw-600 text-uppercase mb-1">Legendary Armour</h6>
                              <div class="mb-0">
                      ...
                      <div class="col-md-12 mb-4">
                        <a href="store-product.html" class="product-item">
                          <div class="row align-items-center no-gutters">
                            <div class="item_img d-none d-sm-block">
                              <img class="img bl-3 text-primary" src="../assets/img/content/cont/product guild dua.png" alt="Games Store">
                            </div>
                            <div class="item_content flex-1 flex-grow pl-0 pl-sm-6 pr-6">
                              <h6 class="item_title ls-1 small-1 fw-600 text-uppercase mb-1">250 Hero Points</h6>
                              <div class="mb-0">
                                <i class="mr-2 fab fa-windows"></i>
                                <i class="mr-2 fab fa-steam"></i>
                                <i class="fab fa-apple"></i>
                      ...
                      <div class="col-md-12 mb-4">
                        <a href="store-product.html" class="product-item">
                          <div class="row align-items-center no-gutters">
                            ...
                            <div class="item_content flex-1 flex-grow pl-0 pl-sm-6 pr-6">
                              <h6 class="item_title ls-1 small-1 fw-600 text-uppercase mb-1">Legendary Armor</h6>
                              <div class="mb-0">
                                <i class="mr-2 fab fa-windows"></i>
                                <i class="mr-2 fab fa-steam"></i>
                                <i class="fab fa-apple"></i>
