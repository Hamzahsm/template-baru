        ...
        <div class="row">
          ...
          <div class="col-4 d-none d-lg-block mx-auto">
            ...
            <form action="../../search.php" method="GET" class="input-group border-0 bg-transparent">
              ...
              <div class="input-group-append">
                <button class="btn btn-sm btn-warning text-secondary my-0 mx-0" type="submit" name="search"><i class="fas fa-search"></i></button>
              </div>
            </form>
          </div>
              ...
              <div class="col-lg-4">
                <div class="filters border border-secondary rounded p-4">
                  ...
                  <li class="nav-item text-light transition mb-2 active">
                    <!-- query live search kita ada disini -->
                  <!-- <form class="input-group border-0 bg-transparent">
                  ...
                  <form action="" method="POST" class="input-group border-0 bg-transparent">
                    <input class="form-control live-search-box" type="search" placeholder="Search" aria-label="Search" name="s" id="search" autocomplete="off">
                    <div class="input-group-append">
                      <button class="btn btn-sm btn-warning text-secondary my-0 mx-0" type="submit" name="search"><i class="fas fa-search"></i></button>
                    </div>
                  </form>
