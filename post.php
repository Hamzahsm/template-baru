...
<html lang="en">
  ...
  <body class="page-body">
    ...
    <header class="news-header p-relative">
      <div class="overlay br-n bs-c bp-r pe-n" data-parallax="scroll" data-z-index="1" data-image-src="./dashboard/images/<?= $result['image']; ?>"></div>
                  ...
                  <div class="review d-flex mb-6 ml-md--6">
                    <div class="autor-post">
                      <div class="autor-btn-se">
                        <span class="autor-name-ft">By AutorName</span>
                      </div>
                    </div>
                    <div class="post-date-se small text-warning mr-4 mr-md-7">
                      <span class="autor-date-ft"><?php echo $result['date'];?></span>
                    </div>
                  </div>
                  <p class="lead-1"><?php echo $result['deskripsi']; ?></p>
                    ...
                    <div class="d-flex flex-column flex-md-row">
                      ...
                      <div class="tags_cloud order-md-1 flex-1">
                        ...
                        <a href="#" class="badge badge-warning px-4 py-2">
                          <i class="fas fa-tags"></i> News
                        </a>
                        <a href="#" class="badge badge-warning px-4 py-2">
                          <i class="fas fa-tags"></i> Game
                        </a>
                        <a href="#" class="badge badge-warning px-4 py-2">
                          <i class="fas fa-tags"></i> <?php echo $result['category']; ?>
                        </a>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-6">
                      <div class="pr-4">
                        ...
                        <a href="#" class="d-block">Maecenas in leo sodales, maximus erat at, cursus ipsum.</a>
                      </div>
                    </div>
                    <div class="col-6">
                ...
                <div class="mt-8">
                  ...
                  <div class="row gutters-y">
                    <div class="col-sm-6 col-lg-4">
                      ...
                      <a href="#" class="d-block text-uppercase fw-500 lh-5 mb-2"><?= $data["title"]; ?></a>
                      <span class="time d-block small-4"><i class="text-warning fas fa-calendar-alt"></i> <?= $data['date']; ?></span>
                    </div>
                    <!-- <div class="col-sm-6 col-lg-4">
                      <img src="assets/img/content/img_01.jpg" alt="Game" class="d-block mb-3">
                          ...
                          <div class="row no-gutters">
                            ...
                            <div class="col-lg-7">
                              <div class="text-gray pl-lg-3">
                                <div class="lh-1"><a href="news.html" class="badge badge-secondary mb-2">article</a></div>
                                <h6 class="text-uppercase mb-0 small-2 fw-400"><a href="news-article.html"><?= $data["title"]; ?></a></h6>
                              </div>
