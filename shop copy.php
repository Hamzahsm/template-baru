                        ...
                        <a href="./power-leveling-150.html" class="product-item">
                          <div class="row align-items-center no-gutters">
                            <div class="item_img d-none d-sm-block">
                              <img class="img bl-3 text-primary" id="image" src="assets/img/content/cont/POWER_LEVELING_1_50_NEW_WORLD_MMOPILOT.png" alt="Games Store" >
                            </div>
                            <div class="item_content flex-1 flex-grow pl-0 pl-sm-6 pr-6">
                              <h6 class="item_title ls-1 small-1 fw-600 text-uppercase mb-1" id="title" >Power Leveling 1-50</h6>
                              <div class="mb-0">
                              ...
                              <div class="position-relative">
                                <span class="item_genre small fw-600" id="category">
                                  MMORPG, NEW WORLD
                                </span>
                              </div>
                            </div>
...
<script
   ...
   <script type="text/javascript">
     $.getJSON("./assets/database/products.json", function(result){
       console.log(result);
       $.each(result, function(i){
        document.getElementById("title").innerHTML +=result[i].name;
       });
     });
   </script>
...
<script>
  var products = [
    {
        "name" : "Leveling 1 - 50",
        "category" : "MMORPG, NEW WORLD",
        "image" : "https://mmopilot.com/wp-content/uploads/2021/10/POWER_LEVELING_1_60_NEW_WORLD_MMOPILOT-4.png"
    }, 
    {
        "name" : "Leveling 41 - 60",
        "category" : "MMORPG, NEW WORLD",
        "image" : "https://mmopilot.com/wp-content/uploads/2021/10/POWER_LEVELING_41_60_NEW_WORLD_MMOPILOT.png"
    },
    {
        "name" : "Leveling 31 - 60",
        "category" : "MMORPG, NEW WORLD",
        "image" : "https://mmopilot.com/wp-content/uploads/2021/10/POWER_LEVELING_31_60_NEW_WORLD_MMOPILOT.png"
    },
    {
        "name" : "Leveling 1 - 20",
        "category" : "MMMORGP, NEW WORLD",
        "image" : "https://mmopilot.com/wp-content/uploads/2021/10/POWER_LEVELING_1_20_NEW_WORLD_MMOPILOT-2.png"
    },
    {
        "name" : "Leveling 21 - 30",
        "category" : "MMMORGP, NEW WORLD",
        "image" : "https://mmopilot.com/wp-content/uploads/2021/10/POWER_LEVELING_21_30_NEW_WORLD_MMOPILOT-1.png"
    }
];
</script>